"""
HRAM (Hierarchical Recursive Action Model) hybrid image policy.

Instead of updating both low latent and high latent on the action decoder, 
low latent is now updated through observation encoder. 
...
class HRAMHybridImagePolicy(BaseImagePolicy):
    ...
    def latent_recursion(self, obs_tokens, z_cvae_token, y, z_L, n, K):
        """HRM-style latent recursion with masked high-latent update.
