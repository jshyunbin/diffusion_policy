...
from diffusion_policy.policy.trm_hybrid_image_policy import TRMHybridImagePolicy
...
class TrainTRMHybridWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        self.model: TRMHybridImagePolicy = hydra.utils.instantiate(cfg.policy)

        self.ema_model: TRMHybridImagePolicy = None
...
def main(cfg):
    workspace = TrainTRMHybridWorkspace(cfg)
    workspace.run()
