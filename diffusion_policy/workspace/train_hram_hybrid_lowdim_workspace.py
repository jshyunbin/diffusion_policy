...
from diffusion_policy.policy.hram_hybrid_lowdim_policy import HRAMHybridLowdimPolicy
...
class TrainHRAMHybridLowdimWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        self.model: HRAMHybridLowdimPolicy = hydra.utils.instantiate(cfg.policy)

        self.ema_model: HRAMHybridLowdimPolicy = None
...
def main(cfg):
    workspace = TrainHRAMHybridLowdimWorkspace(cfg)
    workspace.run()
