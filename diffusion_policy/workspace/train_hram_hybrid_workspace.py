...
from diffusion_policy.policy.hram_hybrid_image_policy import HRAMHybridImagePolicy
...
class TrainHRAMHybridWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        self.model: HRAMHybridImagePolicy = hydra.utils.instantiate(cfg.policy)

        self.ema_model: HRAMHybridImagePolicy = None
...
def main(cfg):
    workspace = TrainHRAMHybridWorkspace(cfg)
    workspace.run()
