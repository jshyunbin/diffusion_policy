...
from diffusion_policy.policy.gram_hybrid_image_policy import GRAMHybridImagePolicy
...
class TrainGRAMHybridWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: GRAMHybridImagePolicy = hydra.utils.instantiate(cfg.policy)

        self.ema_model: GRAMHybridImagePolicy = None
...
def main(cfg):
    workspace = TrainGRAMHybridWorkspace(cfg)
    workspace.run()
