...
from diffusion_policy.policy.act_hybrid_lowdim_policy import ACTHybridLowdimPolicy
...
class TrainACTHybridLowdimWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        self.model: ACTHybridLowdimPolicy = hydra.utils.instantiate(cfg.policy)

        self.ema_model: ACTHybridLowdimPolicy = None
...
def main(cfg):
    workspace = TrainACTHybridLowdimWorkspace(cfg)
    workspace.run()
